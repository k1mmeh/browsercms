...
HTML
  ...
  def self.options
    ...
    file_system_templates = static_sister_class.all_templates
    page_templates = file_system_templates + all
    page_templates.map{|f| [display_name(f.file_name), f.id] }.sort.uniq
  end
